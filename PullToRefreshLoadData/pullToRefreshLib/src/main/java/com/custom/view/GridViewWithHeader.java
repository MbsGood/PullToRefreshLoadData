 ...
 *
 */
public class GridViewWithHeader extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener
{
    ...
    public class mListAdapter extends BaseAdapter
    {
		...
		public int getCount() 
		{
			return originalAdapter.getCount() > 0 ? originalAdapter.getCount() + GridViewWithHeader.this.getNumColumnsCompat() : 0;
		}

		@Override
		public Object getItem(int position) 
		{
//			return originalAdapter.getItem(position + GridViewWithHeader.this.getNumColumnsCompat());
		    return originalAdapter.getItem(position - GridViewWithHeader.this.getNumColumnsCompat());
		}
		...
		{
//			return originalAdapter.getItemId(position + GridViewWithHeader.this.getNumColumnsCompat());
		    return originalAdapter.getItemId(position-GridViewWithHeader.this.getNumColumnsCompat());
		}
		...
		{
			if ( position < GridViewWithHeader.this.getNumColumnsCompat() )
			{
		...
		public View getView(int position, View convert, ViewGroup parent) 
		{
			if ( position < GridViewWithHeader.this.getNumColumnsCompat() )
			{
				...
				int realPosition = position - GridViewWithHeader.this.getNumColumnsCompat();
    ...
    private void drawHeaders() 
    {
    	if ( mHeaderViewInfo != null )
    	{
	    	...
	    	if ( lastPos != startPos && !setFixed && bringToFront) 
	    	{
	    		...
	    		{
			    	ViewGroup.MarginLayoutParams mParams = (android.view.ViewGroup.MarginLayoutParams)mHeaderViewInfo.view.getLayoutParams();
	...
	public void onItemClick(AdapterView<?> adapter, View view, int position, long id) 
	{
		...
		{
			clickListenerFromActivity.onItemClick(adapter, view, position, id);
		}
	}
}
