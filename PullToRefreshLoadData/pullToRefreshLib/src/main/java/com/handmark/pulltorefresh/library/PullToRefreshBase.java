...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private AnimationStyle mLoadingAnimationStyleTop = null;
	private AnimationStyle mLoadingAnimationStyleBottom = null;
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		...
		if (mode == Mode.PULL_FROM_START && mLoadingAnimationStyleTop != null) {
			layout = mLoadingAnimationStyleTop.createLoadingLayout(context, mode,
					getPullToRefreshScrollDirection(), attrs);
		}else if (mode == Mode.PULL_FROM_END && mLoadingAnimationStyleBottom != null) {
			layout = mLoadingAnimationStyleBottom.createLoadingLayout(context, mode,
					getPullToRefreshScrollDirection(), attrs);
		}
		else {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrAnimationStyleTop)) {
			mLoadingAnimationStyleTop = AnimationStyle.mapIntToValue(a.getInteger(
					R.styleable.PullToRefresh_ptrAnimationStyleTop, 0));
		}
		if (a.hasValue(R.styleable.PullToRefresh_ptrAnimationStyleBottom)) {
			mLoadingAnimationStyleBottom = AnimationStyle.mapIntToValue(a.getInteger(
					R.styleable.PullToRefresh_ptrAnimationStyleBottom, 0));
		}
